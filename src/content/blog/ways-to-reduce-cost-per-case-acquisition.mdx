...
The average US law firm spends [$2,500 to $3,000 per signed case](https://www.andava.com/learn/legal-marketing-statistics/) on marketing and acquisition. For personal injury firms in competitive metros, that number climbs much higher. Some spend $4.5 million annually on Google Ads alone to acquire cases at scale.
...
**Single-channel dependence.** If Google Ads is your only acquisition channel, you are paying premium prices for every lead. [Google Ads cost per lead runs $2,000 to $3,000](https://attorneyatlawmagazine.com/legal-marketing/data-driven-growth-how-smart-marketing-analytics-help-law-firms-scale-efficiently) in competitive legal categories. Facebook delivers comparable leads at $500 to $700. That gap represents a 65%+ reduction in cost per lead, but most firms never test the comparison because they do not track attribution across channels.
...
According to [SeoProfy and First Page Sage data](https://www.andava.com/learn/legal-marketing-statistics/), SEO delivers a 526% return on investment over three years. Organic traffic accounts for 52.6% of total law firm website traffic, and SEO leads convert at 7.5% compared to PPC's 2.2%.
...
[Attorney at Law Magazine reported](https://attorneyatlawmagazine.com/legal-marketing/data-driven-growth-how-smart-marketing-analytics-help-law-firms-scale-efficiently) that Facebook delivers leads at $500 to $700 cost per lead compared to Google's $2,000 to $3,000. For firms with an average case value of $10,000 or more, that translates to a greater than 65% CPA reduction.
...
According to [industry data](https://www.andava.com/learn/legal-marketing-statistics/), the average cost per click in legal is $4.26 across all categories, but competitive practice areas drive that number dramatically higher. Workers' compensation keywords run $100 to $200 per click. DUI keywords run $80 to $160.
...
**Practice area patterns.** Personal injury needs roughly [3,000 leads per month from 30,000 clicks](https://www.andava.com/learn/legal-marketing-statistics/) at a 10 to 15% conversion rate to hit 300 cases. Bankruptcy converts at 5 to 12%. Estate planning converts differently from criminal defense. Generic benchmarks miss these differences. Your attribution data captures them.
...
The data on response speed is striking. Firms responding in under five minutes are [21 times more likely to convert](https://konanspade.com/lma/how-lawyers-get-clients-guide-for-client-acq/) than firms responding after 30 minutes. The national average call-to-case conversion rate is just 7%, with a range of 3 to 30%.

That 27-point spread between worst and best performers is almost entirely a function of intake quality.

**AI intake tools** are the fastest path to improvement. One [plaintiff law firm increased conversions by 40%](https://www.andava.com/learn/legal-marketing-statistics/) after implementing AI-powered intake that responded to inquiries in under 30 seconds. The technology did not replace their intake team. It provided instant acknowledgment and basic qualification while routing qualified leads to human staff.
...
Our guide on [intake training and conversion](/blog/law-firm-sales-training/) covers the full process in detail.
...
Law firm expenses rose [9.1% through Q3 2025](https://brightflag.com/resources/law-firm-billing-rates/). Billing rates climbed 7.4%, with Am Law 100 firms averaging an 8.3% increase. Profit margins are tightening.

At the same time, consolidation is accelerating. [Forty-seven law firm mergers](https://www.bestlawfirms.com/articles/law-firm-merger-boom-2026-here-s-why-surge-is-coming/7202) occurred through Q3 2025 alone. Larger, better-funded competitors are entering markets that smaller firms once dominated.

The firms that control their cost per case will survive this shift. The firms that overpay for every client will either sell, merge, or shrink. Acquisition efficiency is not a nice-to-have anymore. It is a competitive necessity. For a full [marketing strategy framework](/guide/law-firm-marketing/), start with our guide.
